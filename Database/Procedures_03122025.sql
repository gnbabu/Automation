/****** Object:  StoredProcedure [aut].[usp_ValidateUserByUsernameAndPassword]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_ValidateUserByUsernameAndPassword]
GO
/****** Object:  StoredProcedure [aut].[usp_UpdateUser]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_UpdateUser]
GO
/****** Object:  StoredProcedure [aut].[usp_UpdateQueueStatus]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_UpdateQueueStatus]
GO
/****** Object:  StoredProcedure [aut].[usp_UpdateAutomationDataSections]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_UpdateAutomationDataSections]
GO
/****** Object:  StoredProcedure [aut].[usp_UpdateAutomationData]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_UpdateAutomationData]
GO
/****** Object:  StoredProcedure [aut].[usp_UpdateAssignedTestCaseStatus]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_UpdateAssignedTestCaseStatus]
GO
/****** Object:  StoredProcedure [aut].[usp_SingleRunTestCaseNow]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_SingleRunTestCaseNow]
GO
/****** Object:  StoredProcedure [aut].[usp_SetUserActiveStatus]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_SetUserActiveStatus]
GO
/****** Object:  StoredProcedure [aut].[usp_ScheduleSingleTestCase]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_ScheduleSingleTestCase]
GO
/****** Object:  StoredProcedure [aut].[usp_RegisterUser]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_RegisterUser]
GO
/****** Object:  StoredProcedure [aut].[usp_InsertTestScreenshot]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_InsertTestScreenshot]
GO
/****** Object:  StoredProcedure [aut].[usp_InsertAutomationDataSection]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_InsertAutomationDataSection]
GO
/****** Object:  StoredProcedure [aut].[usp_InsertAutomationData]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_InsertAutomationData]
GO
/****** Object:  StoredProcedure [aut].[usp_GetUserStatuses]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetUserStatuses]
GO
/****** Object:  StoredProcedure [aut].[usp_GetUserRoles]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetUserRoles]
GO
/****** Object:  StoredProcedure [aut].[usp_GetUserById]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetUserById]
GO
/****** Object:  StoredProcedure [aut].[usp_GetTimeZones]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetTimeZones]
GO
/****** Object:  StoredProcedure [aut].[usp_GetTestCasesByAssignmentNameAndUser]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetTestCasesByAssignmentNameAndUser]
GO
/****** Object:  StoredProcedure [aut].[usp_GetTestCaseAssignmentsByUser]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetTestCaseAssignmentsByUser]
GO
/****** Object:  StoredProcedure [aut].[usp_GetScreenshotsByAssignmentTestCaseId]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetScreenshotsByAssignmentTestCaseId]
GO
/****** Object:  StoredProcedure [aut].[usp_GetScreenshotById]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetScreenshotById]
GO
/****** Object:  StoredProcedure [aut].[usp_GetPriorityStatus]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetPriorityStatus]
GO
/****** Object:  StoredProcedure [aut].[usp_GetPendingExecutionQueues]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetPendingExecutionQueues]
GO
/****** Object:  StoredProcedure [aut].[usp_GetFilteredUsers]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetFilteredUsers]
GO
/****** Object:  StoredProcedure [aut].[usp_GetAutomationFlowNames]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetAutomationFlowNames]
GO
/****** Object:  StoredProcedure [aut].[usp_GetAutomationDataSection]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetAutomationDataSection]
GO
/****** Object:  StoredProcedure [aut].[usp_GetAutomationDataByFlowName]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetAutomationDataByFlowName]
GO
/****** Object:  StoredProcedure [aut].[usp_GetAutomationData]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetAutomationData]
GO
/****** Object:  StoredProcedure [aut].[usp_GetAssignedTestCasesForLibraryAndEnvironment]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetAssignedTestCasesForLibraryAndEnvironment]
GO
/****** Object:  StoredProcedure [aut].[usp_GetAllUsers]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetAllUsers]
GO
/****** Object:  StoredProcedure [aut].[usp_GetAllAssignedTestCasesInLibrary]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_GetAllAssignedTestCasesInLibrary]
GO
/****** Object:  StoredProcedure [aut].[usp_get_AutomationFlowNames]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_get_AutomationFlowNames]
GO
/****** Object:  StoredProcedure [aut].[usp_get_AutomationDataSection]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_get_AutomationDataSection]
GO
/****** Object:  StoredProcedure [aut].[usp_DeleteUser]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_DeleteUser]
GO
/****** Object:  StoredProcedure [aut].[usp_DeleteTestScreenshotById]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_DeleteTestScreenshotById]
GO
/****** Object:  StoredProcedure [aut].[usp_DeleteAutomationDataSection]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_DeleteAutomationDataSection]
GO
/****** Object:  StoredProcedure [aut].[usp_DeleteAutomationData]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_DeleteAutomationData]
GO
/****** Object:  StoredProcedure [aut].[usp_CreateUser]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_CreateUser]
GO
/****** Object:  StoredProcedure [aut].[usp_CreateOrUpdateAssignmentWithTestCases]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_CreateOrUpdateAssignmentWithTestCases]
GO
/****** Object:  StoredProcedure [aut].[usp_ChangePassword]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_ChangePassword]
GO
/****** Object:  StoredProcedure [aut].[usp_BulkScheduleTestCases]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_BulkScheduleTestCases]
GO
/****** Object:  StoredProcedure [aut].[usp_BulkRunTestCasesNow]    Script Date: 03-12-2025 09:50:51 ******/
DROP PROCEDURE IF EXISTS [aut].[usp_BulkRunTestCasesNow]
GO
/****** Object:  StoredProcedure [aut].[usp_BulkInsertTestScreenshots]    Script Date: 03-12-2025 09:50:51 ******/
